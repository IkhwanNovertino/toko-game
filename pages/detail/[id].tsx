...
import TopUpForm from "../../components/organism/top-up-form";
import TopUpItem from "../../components/organism/top-up-item";
import { GameListTypes, NominalsTypes, PaymentTypes } from "../../services/data-types";
import { getDetailVoucher, getFeaturedGame } from "../../services/player";

interface DetailProps {
  dataItem: GameListTypes;
...
export async function getStaticPaths() {
  ...
  const paths = data.map((item: GameListTypes) => ({
    params: {
      id: item._id,
    },
  }));
